...
(function($, window, undefined){
  ...
  Hangman = {
    init: function(words){
      ...
      this.goodSound = new Audio("https://www.youtube.com/watch?v=IUyy0ftlEoE"),
     
      this.badSound = new Audio("https://www.youtube.com/watch?v=X9uRCKtaOCU"),
           this.winSound = new Audio("https://www.youtube.com/watch?v=EMYOiK_iQeY"),
  ...
  var wordList = ["ppvic", "rose", "daisy", "lotus", "lily", "library", "mmlc", "graden", "coverplayground", "hall", "classrooms", "chapel", "tuckshop","chinese", "english", "mathematics", "intergratedScience", 
"intergatedHumanities", "chineseHistory",  "geography", " physics", "biology", "music", "computerLiteracy"];
